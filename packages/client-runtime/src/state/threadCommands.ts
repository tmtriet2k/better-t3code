...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    setAutoPickup: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:set-auto-pickup",
      execute: (input: SetThreadAutoPickupInput) => setThreadAutoPickup(input),
      scheduler,
      concurrency,
    }),
