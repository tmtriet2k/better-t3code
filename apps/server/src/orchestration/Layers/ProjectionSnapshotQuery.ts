          ...
          ([
            ...
            Effect.gen(function* () {
              ...
              const threads: ReadonlyArray<OrchestrationThread> = threadRows.map((row) => ({
                ...
                runtimeMode: row.runtimeMode,
                autoPickupState: row.autoPickupState,
                autoPickedUpAt: row.autoPickedUpAt,
  ...
  const getThreadShellById: ProjectionSnapshotQueryShape["getThreadShellById"] = (threadId) =>
    Effect.gen(function* () {
      ...
      return Option.some({
        ...
        autoPickupState: threadRow.value.autoPickupState,
        autoPickedUpAt: threadRow.value.autoPickedUpAt,
