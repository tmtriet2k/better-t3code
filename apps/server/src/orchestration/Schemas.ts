import {
  ...
  ThreadAutoPickupSetPayload as ContractsThreadAutoPickupSetPayloadSchema,
...
export const ThreadAutoPickupSetPayload = ContractsThreadAutoPickupSetPayloadSchema;
