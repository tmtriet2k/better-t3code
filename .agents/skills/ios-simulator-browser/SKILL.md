...
Use serve-sim as the shared visual feed for an iOS Simulator. Use `ios-debugger-agent` and XcodeBuildMCP semantic UI tools to drive the app; browser-canvas coordinates are a fallback, not the primary automation surface.
